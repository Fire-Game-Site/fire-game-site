...
var announcement = { // both support html, so if you want something like a link use <a> or if you want a newline use <br />
    ...
    description: `If this website is blocked, go to the new alternate links: <a href='https://flamingsite.vercel.app'>flamingsite.vercel.app</a> or <a href='https://flamingsite.github.io'>flamingsite.github.io</a><br />NOTE: IF YOU CLICK A BUTTON OR GAME AND NOTHING HAPPENS, GIVE THE SITE A BIT TO LOAD <br /> <br />March 6, 2024: We are aware of the many reports of broken games; our Devs are currently in the process of repairing a bug in some of the games. The message should look like an error for Google.<br /> <br />The known games affected are listed below:<br />All Games in the MotoX3M Series<br />Run 1 and Run 2<br />Idle Breakout<br />Awesome Planes<br />World’s Hardest Game 1<br />Big Tower Tiny Square<br />Big Ice Tower Tiny Square<br />Big Tower Tiny Square 2<br />Snow Rider 3D<br />The Impossible Game<br />Raft Wars 1 and Raft Wars 2<br />FNAF<br />Tetris<br />Penalty Kick Online<br /> <br />NOTE: This list will update as games are repaired.<br />Please reach out to us if there are other broken games.<br /> <br />-Head of Games and Development at Fire Games Corp`
}
