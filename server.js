...
var announcement = { // both support html, so if you want something like a link use <a> or if you want a newline use <br />
    ...
    description: `Our team has been hard at work to deliver the best experience to you. Our most recent update has the most changes to the code that any update has ever had on this site, ever. Everything has been updated to fit Google's much more modern Material Design Guidelines (also known Material M3 or Material You). The red is gone from the site for now, but may make a surprise return sometime in the near future. We hope you enjoy the new UI, and if you have any issues at all, click the contact button in the top right and fill out the form with information on your issue or request.<br /><br />NOTE: IF YOU CLICK A BUTTON OR GAME AND NOTHING HAPPENS, GIVE THE SITE A BIT TO LOAD<br />NOTE: OUR TEAM IS CURRENTLY HARD AT WORK TO DESIGN BRAND NEW THUMBNAILS FOR NEW GAMES<br /> <br />April 18, 2024: Added Super Mario Bros and Super Mario 64.<br /> <br />April 16, 2024: BIG UPDATE: We have added 5 new games which include Penalty Shooters 1 and 2, Quake, Multitask Air, A Dance of Fire and Ice, and YoHoHo.io. If you want a game on the site, feel free to contact us. In this update, we have fixed many bugs. If more bugs arise, feel free to contact us. The third and final part of this update is the addition of many new descriptions, developers, etc. to many games.<br /> <br />April 12, 2024: Added an arcade version of Tom Clancy's Rainbow 6 Siege. Let us know if there are any bugs with it.`
}
