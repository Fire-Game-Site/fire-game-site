...
var announcement = { // both support html, so if you want something like a link use <a> or if you want a newline use <br />
    ...
    description: `Our team has been hard at work to deliver the best experience to you. Our most recent update has the most changes to the code that any update has ever had on this site, ever. Everything has been updated to fit Google's much more modern Material Design Guidelines (also known Material M3 or Material You). The red is gone from the site for now, but may make a surprise return sometime in the near future. We hope you enjoy the new UI, and if you have any issues at all, click the contact button in the top right and fill out the form with information on your issue or request.<br /><br />NOTE: IF YOU CLICK A BUTTON OR GAME AND NOTHING HAPPENS, GIVE THE SITE A BIT TO LOAD<br />NOTE: OUR TEAM IS CURRENTLY HARD AT WORK TO DESIGN BRAND MEW THUMBNAILS FOR NEW GAMES<br /> <br />April 9, 2024: Fixed fullscreen ad bug<br /> <br />March 29, 2024: Removed FNAF as it was broken and had very low demand. Added Subway Surfers, which has many different maps in it. Also added Sausage Flip. <br /> <br />March 26, 2024: Added a highly requested Fortnite Tracker. We also fixed the World's Hardest Game.`
}
